...
import { admingetcategory } from "@/api/article";
async function getcate() {
  let result = await admingetcategory();
...
async function show() {
  ...
  let result = await admingetarticle(params);
    ...
    >
      ...
      <el-form :model="articleModel" label-width="100px" >
        ...
        <el-form-item label="文章分类">
          <el-select placeholder="请选择" v-model="articleModel.categoryId" :disabled="true">
            <el-option
              v-for="c in categorys"
              :key="c.id"
              :label="c.categoryName"
        ...
        <el-form-item label="文章内容" :disabled="true">
        ...
        <el-form-item>
          <el-button type="success" @click="title=='添加文章'? add('已发布'):update('已发布')">通过</el-button>
          <el-button type="danger" @click="title=='添加文章'? add('审核未通过'):update('审核未通过')">不通过</el-button>
        </el-form-item>
      </el-form>
    </el-drawer>
  </el-card>
